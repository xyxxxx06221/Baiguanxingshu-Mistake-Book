...
本项目是个人学习工具，与任何考试主管部门、培训机构、DeepSeek 或题库权利人均无隶属或官方合作关系。“百官行述”是项目名称，不代表官方内容或结果保证。
...
- 本项目不提供账户、云同步或遥测。
- 项目按本机运行设计。不要把带有个人 API Key 的实例直接暴露到公网。
...
首次发布的验证结果与限制见 [RELEASE_NOTES_v0.1.0.md](./RELEASE_NOTES_v0.1.0.md)。
